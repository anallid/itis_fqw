...
# Измененная оболочка SkipFrame для регистрации кадров и действий
    ...
    while not done:
        ...
        if done:
            ...
            if info["flag_get"]:
                ...
                frame_skip_env = env.env.env.env # Разворачиваем окружение, чтобы получить обертку SkipFrame
...
# Рамки контроллера (для прозрачного фона)
